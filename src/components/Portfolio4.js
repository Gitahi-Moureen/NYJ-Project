    ...
    return (
        <div className='portfolio'>
            <div className='skills'>
                <img src="/images/Maggy.jpeg" alt="Profile" className='label' />
                <p>+254 748 878 168 <br /> margaretmacharianyambura@gmail.com <br /> LinkedIn <br /> GitHub</p>
