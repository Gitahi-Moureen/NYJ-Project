    ...
    return (
        <div className='portfolio'>
            <div className='skills'>
                <img src="/images/Tuukuo.jpeg" alt="Profile" className='label' />
                <p>+254 748 878 168 <br /> tuukuodorcas@gmail.com <br /> LinkedIn <br /> GitHub</p>
